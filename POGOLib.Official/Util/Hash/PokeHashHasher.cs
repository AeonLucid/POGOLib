            ...
            using (var response = await PerformRequest(requestContent))
            {
                ...
                switch (response.StatusCode)
                {
                    case HttpStatusCode.OK:
                        ...
                        hashData.LocationAuthHash = responseData.LocationAuthHash;
                        hashData.LocationHash = responseData.LocationHash;
                        var arr = new  List<ulong>();
                        foreach (var element in responseData.RequestHashes) {
                            arr.Add( unchecked((ulong) element));
                        }
                        hashData.RequestHashes = arr.ToArray();
                        return hashData;
                        /*
                        return 
                        {
