...
namespace POGOLib.Pokemon.Proto.Player {
  ...
  public static partial class ContactSettingsReflection {
    ...
    static ContactSettingsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChxQbGF5ZXIvQ29udGFjdFNldHRpbmdzLnByb3RvEhxQT0dPTGliLlBva2Vt",
            "b24uUHJvdG8uUGxheWVyIlEKD0NvbnRhY3RTZXR0aW5ncxIdChVzZW5kX21h",
            "cmtldGluZ19lbWFpbHMYASABKAgSHwoXc2VuZF9wdXNoX25vdGlmaWNhdGlv",
            "bnMYAiABKAhiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::POGOLib.Pokemon.Proto.Player.ContactSettings), global::POGOLib.Pokemon.Proto.Player.ContactSettings.Parser, new[]{ "SendMarketingEmails", "SendPushNotifications" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class ContactSettings : pb::IMessage<ContactSettings> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::POGOLib.Pokemon.Proto.Player.ContactSettingsReflection.Descriptor.MessageTypes[0]; }
    }
