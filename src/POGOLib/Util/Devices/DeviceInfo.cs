...
namespace POGOLib.Util.Devices
{
    ...
    {
        // TODO: Include an user agent for each device.
        ...
        private static readonly Dictionary<string, Device> Devices = new Dictionary<string, Device>
        {
            ...
            },
            {
                ...
                new Device
                {
                    ...
                    UserAgent = "Dalvik/2.1.0 (Linux; U; Android 5.0; Nexus 5 Build/LPX13D)"
                }
            },
            {
                "xoom",
        ...
        {
            return Devices.ElementAt(Random.Next(0, Devices.Count)).Value;
        }
